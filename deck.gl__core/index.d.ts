...
declare module '@deck.gl/core/utils/globals' {
	...
	const window_: (Window & typeof globalThis) | NodeJS.Global;
	const global_: (Window & typeof globalThis) | NodeJS.Global;
	const document_: {};
...
declare module '@deck.gl/core/shaderlib/project64/project64' {
	...
	function getUniforms(opts?: {}, context?: {}): any;
...
declare module '@deck.gl/core/lib/layer' {
	...
	export interface LayerInputHandler {
		(o: PickingInfo<any>, e: HammerInput): void;
	}
...
declare module '@deck.gl/core/lib/deck' {
	...
	export interface PickingInfo<D> {
		coordinate?: object;
		index: number;
		layer: Layer<D>,
		object: object;
	...
	export interface DeckProps {
		// https://github.com/visgl/deck.gl/blob/8.1-release/modules/core/src/lib/deck.js
		...
		onBeforeRender?: () => any;
		onAfterRender?: () => any;
		onClick?: <D>(info: PickingInfo<D>, pickedInfos: PickingInfo<D>[], e: MouseEvent) => any;
		onHover?: <D>(info: PickingInfo<D>, pickedInfos: PickingInfo<D>[], e: MouseEvent) => any;
		onDragEnd?: <D>(info: PickingInfo<D>, e: MouseEvent) => any;
		onLoad?: () => any;
		onError?: () => any;
...
declare module '@deck.gl/core/controllers/orbit-controller' {
	...
	export class OrbitState extends ViewState {
		constructor({
			ViewportType, width, // Width of viewport
...
declare module '@deck.gl/core' {
	...
	export { default as Deck, DeckProps, PickingInfo } from '@deck.gl/core/lib/deck';
	export { default as LayerManager } from '@deck.gl/core/lib/layer-manager';
	export { Position } from '@deck.gl/core/utils/positions';
	export { default as AttributeManager } from '@deck.gl/core/lib/attribute-manager';
	export { default as Layer } from '@deck.gl/core/lib/layer';
	export { default as CompositeLayer } from '@deck.gl/core/lib/composite-layer';
